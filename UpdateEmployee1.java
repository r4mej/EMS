...
public class UpdateEmployee1 extends JFrame implements ActionListener{
    ...
    UpdateEmployee1(String empId){
        ...
        lnametf.setBounds(620, 200, 150,30);
        add(lnametf);
...
//        add(designationtf);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == add){
            ...
            try{
                Conn conn = new Conn();
                String query = "update employee set name = '"+name+"', mname = '"+mname+"', lname = '"+lname+"', address = '"+address+"', phone = '"+phone+"', email = '"+email+"', education = '"+education+"',id = '"+id+"', vid = '"+vid+"' where empId = '"+empId+"'";
